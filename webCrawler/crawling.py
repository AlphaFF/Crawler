...
# -*- coding: utf-8 -*-
# @Author: wangfeng1
# @Date:   2019-02-14 14:30:52
# @Email: liushahedi@gmail.com
# @Last Modified by:   wangfeng1
# @Last Modified time: 2019-02-14 16:01:19
...
class Crawler:
    """Crawl a set of URLS.
    This manages two sets of URLS: 'urls' and 'done', 'urls' is a set of URLS seen, and 'done' is a list of FetchStatistics
    """
        ...
        for root in roots:
            ...
            if re.match(r'\A[\d\.]*\Z', host):
                ...
                if self.strict:
                    ...
                    self.root_domains(lenient_host(host))
        for root in roots:
            self.add_url(root)
        self.t0 = time.time()
        self.t1 = None
    ...
    def _host_okay_strictish(self, host):
        ...
        This checks for equality modulo an initial 'www.' + host.
        """
    ...
    def fetch(self, url, max_redirect):
        ...
        while tries < self.max_tries:
            try:
                response = yield from self.self.session.get(url, allow_redirect=False)
                if tries > 1:
    ...
    @asyncio.coroutine
    def crawl(self):
        """Run the crawler until add finished."""
